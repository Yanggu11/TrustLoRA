params = {
    ...
    "use_hypernet": False,
    # which layeres to freeze (not necessary when using peft lora, since it automatically freezes most of them)
    "layers_to_freeze": [
        "embeddings",
        "layer.0",
        "layer.1",
    ...
    "output_dir": f"./pretrained_models/roberta-base-with-classifer",
    "eval_strategy": "epoch",
    "eval_steps": 50,
    "save_strategy": "steps",
