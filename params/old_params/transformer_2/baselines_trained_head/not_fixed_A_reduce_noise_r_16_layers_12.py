params = {
    ...
    "model_name": "./pretrained_models/roberta-base-with-classifier_cola_1757839415",  # here you need to adjust the path to the trained model
    "use_hypernet": True,
    "layers_to_freeze": [],
    # custom learning rate for classification head
    "classification_head_lr": 1e-3,
    # lora params
    "use_peft": True,
    "lora_r": 16,
    "lora_alpha": 16,
