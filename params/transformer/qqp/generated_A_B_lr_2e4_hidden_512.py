params = {
    ...
    "hypernet_hidden_dim": 512,  # Changed
    ...
    "output_dir": f"./pretrained_models/basic_lr_2e4_hidden_512",
    "eval_strategy": "epoch",
    "eval_steps": 5,
    "save_strategy": "steps",
    ...
    "disable_tqdm": True,
    # filenames and else
    "results_dir": "./results/basic_lr_2e4_hidden_512",
    "num_runs": 3,
    "seed": 11,
}