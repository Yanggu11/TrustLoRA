params = {
    ...
    "hypernet_transformer_nhead": 32,
    "hypernet_transformer_num_layers": 6,
    "hypernet_noise_type_A": "add",
    "hypernet_noise_type_B": "add",
    "hypernet_reduce_noise_alpha": True,
    "hypernet_noise_alpha": 0.99,
    ...
    "output_dir": f"./pretrained_models/cola_hnet_nhead32_layers6_hid512_emb128",
    "eval_strategy": "epoch",
    "eval_steps": 5,
    "save_strategy": "steps",
    ...
    "optim": "adamw_torch",
    "disable_tqdm": True,
    "results_dir": "./results/cola_hnet_nhead32_layers6_hid512_emb128",
    "num_runs": 3,
    "seed": 11,
}
